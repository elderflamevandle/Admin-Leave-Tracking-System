  ...
  return (
    <header className="flex h-14 items-center justify-between border-b bg-white px-4">
      <div className="flex items-center gap-2">
        <MobileDrawer />
        <Link href="/dashboard" className="text-lg font-bold text-slate-900 hidden md:block">
          VC Firm
        </Link>
        <Link href="/dashboard" className="text-lg font-bold text-slate-900 md:hidden">
          VC
        </Link>
      </div>
