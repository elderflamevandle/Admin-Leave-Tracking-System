...
import { PlaceholderWidget } from "@/components/features/dashboard/placeholder-widget";
...
export default function SettingsPage() {
  ...
  const save = useMutation({
    mutationFn: async (updates: Record<string, unknown>) => {
      const res = await authFetch("/api/v1/admin/settings", { method: "PATCH", body: JSON.stringify(updates) });
